...
def main():
    ...
    if selected_tab == 'Shooting Analysis':
        ...
        if video_file is not None:
            ...
            convert_to_mp4('../output/output_video.mp4','../output/output_video.mp4')
        ...
        if(video_file is not None):
            ...
            folder_path = '/Users/igautam/Documents/GitHub/basketball-shot-analysis/output/traces'
            image_pattern = '*.jpg'
        ...
        if video_player_file is not None and video_comparison_file is not None:
            # Save uploaded video file
            video_player_path = 'video_player_file.mp4'
            with open(video_player_path, 'wb') as f:
                f.write(video_player_file.read())
            
            # Save uploaded video file
            video_comparison_path = 'video_comparison_file.mp4'
            ...
            with st.spinner('Processing video...'):
                ...
                convert_to_mp4('../output/output_video.mp4','../output_comparison/output_video_player.mp4')
                shooting_time_c, release_angle_c, make_or_miss_c = process_video(video_comparison_path)
                convert_to_mp4('../output/output_video.mp4','../output_comparison/output_video_comparison.mp4')
            ...
            with col1:
                ...
                st.video('../output_comparison/output_video_player.mp4')

            # Video 2
            with col2:
                st.subheader('Processed Video 2')
                st.video('../output_comparison/output_video_comparison.mp4')
